...
- **学習履歴** — 正解回数で習熟度を管理
- **週間レポート** — 曜日別の正解数グラフと週の学習サマリーを表示
- **単語検索** — 学習言語・日本語で部分一致リアルタイム検索
...
- **定着システム** — 5回正解で定着済み。不正解だと学習中に戻る
- **特別休暇チケット** — 3日連続学習で1枚獲得。休んだ日に自動使用してストリーク継続
- **Phrase of the Day** — 登録語彙からランダムに毎日1フレーズ表示
- **読み上げ機能** — カード・クイズ・スペリング全モードで学習言語の音声を再生
- **文字サイズ調整** — カード・選択肢・一覧・UIを個別にサイズ変更可能
